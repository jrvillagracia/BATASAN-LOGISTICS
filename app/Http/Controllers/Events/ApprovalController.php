    ...
    public function approve(Request $request)
    {
        ...
        if ($event) {
            ...
            ApprovedReq::create([
                ...
                'EventsActBldName' => $event->EventsActBldName,
                'EventsActRoom' => $event->EventsActRoom,
                'EventsActivityInventory' => $event->EventsActivityInventory,
                'EventActCategoryName' => $event->EventActCategoryName,
                'EventActType' => $event->EventActType,
                'EventActUnit' => $event->EventActUnit,
                'EventActQuantity' => $event->EventActQuantity,
                'created_at' => now(),
                'updated_at' => now(),
            ]);
