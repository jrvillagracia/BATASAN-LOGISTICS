        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 ">Completed Order</a>
                </div>
            </li>
    ...
    <div class="bg-gray-100 h-auto rounded-lg ">
        ...
        <div class="flex justify-between items-center mt-4 px-9 py-2">
            ...
            <div id="tabs-container" class="relative">
                <a href="{{route('admin_POInventory')}}" class="pageloader button border-b-2 py-2 px-4 transition-all duration-300 translate-x-2">For Approval</a>
                ...
                <a href="{{route('admin_POCompleteOrderInventory')}}" class="pageloader button border-b-2 border-blue-500 py-2 px-4 transition-all duration-300 translate-x-2">Completed Request</a>
            </div>
            ...
            <div class=" flex items-center space-x-4">
                ...
                <form id="ProductOrderSearchForm" class="flex items-center space-x-4">
                    <div class="relative w-96">
                        ...
                        <input type="search" id="ProductOrderSearch" name="ProductOrderSearch" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" />
                    </div>
                    <!-- Add Item Button -->
            </div>
        </div>
        ...
        <div class="relative shadow-md sm:rounded-lg px-9 py-5">
            <table id="POTable" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody id="tableBody" class="">
                    ...
                    <tr class="odd:bg-blue-100 even:bg-white  border-b" data-index="" data-id="">
                        ...
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">9/21/2024</td>
                        <td class="px-6 py-4">
                            <button id="POCompletedOrderViewBTN" type="button" class="bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded">View</button>  
                        </td>
                    </tr>
            ...
            <!-- View Popup Card -->
            <div id="ViewComOrderPOPopupCard" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
                <div class="bg-white p-4 rounded-lg shadow-lg w-full max-w-4xl max-h-[80vh] overflow-y-auto">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <button id="closeViewComOrderPOPopupCard" class="text-gray-500 hover:text-gray-700">
                    ...
                    <div class="grid grid-cols-2 gap-4 ml-6 text-sm w-full">
                        <div>
                            ...
                            <p class="mb-2"><strong>Date Complete:</strong></p>
                        </div>
                    </div>
                    ...
                    <div class="relative shadow-md sm:rounded-lg px-9 py-5 max-h-96 overflow-y-auto">
                        ...
                        <div class="flex justify-end space-x-4 pt-5">
                            <button id="printPOCompletedOrderPopupCard" type="button" class="bg-green-500 hover:bg-green-700 text-white py-2 px-4 rounded">Print</button>
                        </div>
