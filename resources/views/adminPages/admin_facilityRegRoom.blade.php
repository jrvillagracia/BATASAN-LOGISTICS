        ...
        <div class="flex justify-between items-center mt-4 px-9 py-2">
            ...
            <div class=" flex items-center space-x-4">
                ...
                <div class="relative w-96">
                    ...
                    <input type="search" id="RegSearch" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" required />
                ...
                <tbody id="tableBody">
                    ...
                    <tr class="odd:bg-blue-100 even:bg-white border-b" data-index="{{$loop->index}}" data-id="{{$room['roomId']}}"
                        ...
                        <td scope="col" class="px-6 py-4">
                            <div class="flex items-center">
                                <input id="RegRoomCheckBox" type="checkbox" class="row-checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600">
