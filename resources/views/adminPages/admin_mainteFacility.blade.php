    ...
    <div class="bg-gray-100 h-auto rounded-lg ">
        ...
        <div class="flex justify-between items-center mt-4 px-9 py-2">
            ...
            <div id="tabs-container" class="relative">
                <a href="{{route('admin_mainteFacility')}}" class="button border-b-2 border-blue-500 py-2 px-4 transition-all duration-300 translate-x-2">For Approval</a>
                <a href="{{route('admin_mainteForRepFacility')}}" class="button border-b-2 py-2 px-4 transition-all duration-300 translate-x-2">For Repair</a>
        ...
        <div class="relative shadow-md sm:rounded-lg px-9 py-5">
            ...
            <div id="ViewMainteFacilityPopupCard" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
                <div class="bg-white p-4 rounded-lg shadow-lg max-w-md w-full max-h-[80vh] overflow-y-auto">
                    <div class="flex justify-between items-center mb-4">
                        ...
                        <button id="closeViewMainteFacilityPopupCard" class="text-gray-500 hover:text-gray-700">
                    ...
                    <div class="flex justify-end space-x-4">
                        <button id="printForApprMainteFacilityPopupCard" class="bg-green-400 hover:bg-green-500 text-white py-2 px-4 rounded">Print</button>
                        <button id="cancelForApprMainteFacilityPopupCard" class="bg-red-400 hover:bg-red-500 text-white py-2 px-4 rounded">Cancel</button>
                    </div>
                </div>
            ...
            <div id="ApprMainteFacilityPopupCard" class="hidden fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
                <div class="bg-white p-6 rounded-lg shadow-lg w-80">
                    ...
                    <div class="flex justify-center space-x-4">
                        <button id="submitApprMainteFacilityPopupCard" class="bg-green-400 hover:bg-green-500 text-white py-2 px-4 rounded">Submit</button>
                        <button id="closeApprMainteFacilityPopupCard" class="bg-red-400 hover:bg-red-500 text-white py-2 px-4 rounded">Cancel</button>
                    </div>
                </div>
            </div>
            ...
            <div id="DclnMainteFacilityPopupCard" class="hidden fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-50">
                <div class="bg-white p-6 rounded-lg shadow-lg w-80">
                    ...
                    <div class="flex justify-center space-x-4">
                        <button id="submitDclnMainteFacilityPopupCard" class="bg-green-400 hover:bg-green-500 text-white py-2 px-4 rounded">Submit</button>
                        <button id="closeDclnMainteFacilityPopupCard" class="bg-red-400 hover:bg-red-500 text-white py-2 px-4 rounded">Cancel</button>
                    </div>
                </div>
            </div>
