            ...
            <div class=" flex items-center space-x-4">
                ...
                <form id="MainteFacilitySearchForm" class="flex items-center space-x-4">
                    <div class="relative w-96">
                        ...
                        <input type="search" id="MainteFacilitySearch" name="MainteFacilitySearch" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" />
                    </div>
        ...
        <div class="relative shadow-md sm:rounded-lg px-9 py-5">
            <table id="MainteFacilityTable" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody id="tableBody" class="">
                    ...
                    <tr class="odd:bg-blue-100  even:bg-white  border-b  " data-index="{{$loop->index}}" data-id="{{$mainteFacility->mainteFacilityId}}"
                        ...
                        <div class="grid grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input id="MainteFacilityDate" type="text" readonly class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Select date">
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="time" id="MainteFacilityTime" name="MainteFacilityTime" class="bg-gray-50 border leading-none border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:focus:ring-blue-500 dark:focus:border-blue-500" min="09:00" max="18:00" required />
                                </div>
                            </div>
                        </div>
