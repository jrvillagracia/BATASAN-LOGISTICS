                ...
                <tbody id="tableBody">
                    <tr class="odd:bg-blue-100  even:bg-white  border-b 0" data-index="" data-id="">
                        <td scope="col" class="px-6 py-4">
                            <div class="flex items-center">
                                <input id="OfficeRoomCheckBox" type="checkbox" class="row-checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600">
