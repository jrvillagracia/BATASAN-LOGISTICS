            ...
            <div class=" flex items-center space-x-4">
                ...
                <form id="eventSearchForm" class="flex items-center space-x-4">
                    <div class="relative w-96">
                        ...
                        <input type="search" id="eventHistorySearch" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500  dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Search" />
            ...
            <table id="EventHistoryTable" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody id="tableBody" class="">
                    <tr class="odd:bg-blue-100  even:bg-white  border-b  " data-index="" data-id="">
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">BHNHS-2024-00222</td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">Sir Jersom</td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">Action</td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">TLE-0001</td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">10/10/2024</td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">3:00PM</td>
                    </tr>
