        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2">Approve Order</a>
                </div>
            </li>
    ...
    <div class="bg-gray-100 h-auto rounded-lg ">
        ...
        <div class="flex justify-between items-center mt-4 px-9 py-2">
            ...
            <div id="tabs-container" class="relative">
                ...
                <a href="{{route('admin_POApprOrderInventory')}}" class="pageloader button border-b-2 py-2 px-4 border-blue-500 transition-all duration-300 translate-x-2">Approve Order</a>
                        ...
                        <table id="step2ReqEquipContentTable" class="w-full border-collapse">
                            ...
                            <tbody id="ViewProductOrder-TablBody">
                                ...
                                <tr class="ViewProductOrder-Rows">
                                    <td class="p-2">
                                        <input id="ViewApproveOrderPOCheckBox" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 ">
                                    </td>
