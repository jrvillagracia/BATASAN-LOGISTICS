    ...
    <div class="bg-gray-100 h-auto rounded-lg ">
        ...
        <div class="flex justify-between items-center mt-4 px-9 py-2">
            ...
            <div id="tabs-container" class="relative">
                ...
                <a href="{{route('admin_HistoryMainteFacility')}}" class="pageloader button border-b-2 border-blue-500 py-2 px-4 transition-all duration-300 translate-x-2">History</a>
            </div>
