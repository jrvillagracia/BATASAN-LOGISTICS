    ...
    <div class="bg-gray-100 h-auto rounded-lg ">
        ...
        <div class="flex justify-between items-center mt-4 px-9 py-2">
            ...
            <div id="tabs-container" class="relative">
                ...
                <a href="{{route('admin_ComReqMainteEquip')}}" class="pageloader button border-b-2 border-blue-500 py-2 px-4 transition-all duration-300 translate-x-2">Completed Request</a>
        ...
        <div class="relative shadow-md sm:rounded-lg px-9 py-5">
            <table id="MainteInventoryTable" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody id="tableBody" class="">
                    ...
                    <tr class="odd:bg-blue-100  even:bg-white  border-b  " data-index="" data-id="">
                        ...
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">BHNHS-2024-0001</td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">Sir. Vic</td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">TLE Department</td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">LAPDELL-001234</td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">LPT-0001</td>
            ...
            <div id="COMREQViewMainteInventoryPopupCard" class="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50 hidden">
                <div id="view-COMREQmaintequip-pdf-content" class="bg-white p-4 rounded-lg shadow-lg max-w-md w-full max-h-[80vh] overflow-y-auto">
                    ...
                    <div class="flex justify-end space-x-4">
                        <button id="printViewComReqMainteInventoryPopupCard" class="com-req-print-btn bg-green-500 hover:bg-green-600 text-white py-2 px-4 rounded">Print</button>
                        <button id="closeViewComReqrMainteInventoryPopupCard" class="com-req-close-btn bg-red-500 hover:bg-red-600 text-white py-2 px-4 rounded">Close</button>
                    </div>
                </div>
