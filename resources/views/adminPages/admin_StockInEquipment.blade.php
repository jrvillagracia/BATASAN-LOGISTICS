...
<section>
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 ">Stock In</a>
                </div>
            </li>
    ...
    <div class="bg-gray-100 h-auto rounded-lg ">
        ...
        <div class="flex justify-between items-center mt-4 px-9 py-2">
            ...
            <div>
                <a href="{{ route('admin_StockInEquipment') }}" class="pageloader button border-b-2 border-blue-500 py-2 px-4 transition-all duration-300 translate-x-2">Stock In</a>
        ...
        <div class="relative shadow-md sm:rounded-lg px-9 py-5">
            <table id="dynamicTable" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody id="tableBody">
                    ...
                    <tr class="odd:bg-blue-100  even:bg-white  border-b " data-id="{{$item->equipmentId}}" data-brand="{{$item->EquipmentBrandName}}"
                        ...
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">{{$item->EquipmentStatus}}</td>
                        ...
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">{{$item->EquipmentClassification}}</td>
                        <td class="px-6 py-4">
                        ...
                        <tbody id="tableViewBodyEquipment">
                            ...
                            <tr class="odd:bg-blue-100  even:bg-white  border-b " 
                                ...
                                <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                    <input id="StockInCheckBox" type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 ">
                                </td>
