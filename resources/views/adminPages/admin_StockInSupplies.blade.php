        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="#" class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 ">Supplies</a>
                </div>
            </li>
        ...
        <div class="relative shadow-md sm:rounded-lg px-9 py-5 ">
            <table id="dynamicTable" class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                ...
                <tbody id="tableBody">
                    ...
                    <tr class="odd:bg-blue-100 even:bg-white border-b " data-id="{{$item->suppliesId}}" data-brand="{{$item->SuppliesBrandName}}"
                        ...
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">{{$item->SuppliesCategory}}</td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">{{$item->SuppliesQuantity}}</td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">₱{{number_format($item->totalPrice,2)}}</td>
                        <td class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap ">{{$item->SuppliesSKU}}</td>
                        ...
                        <td class="px-6 py-4 border-b border-gray-300">
                            ...
                            <button id="editSuppButton" type="button">
                                <svg class="w-[27px] h-[27px] text-blue-600  hover:text-blue-800 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
