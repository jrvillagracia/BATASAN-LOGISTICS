        ...
        <main id="main-content" class="flex-1 p-8 transition-all duration-300 ease-in-out ml-80">
            ...
            <section>
                <div class="flex items-center pb-8">
                    ...
                    <h1 class="text-3xl font-bold ml-2">Facility Special Room</h1>
                </div>
                ...
                <div class="bg-gray-100 h-auto rounded-lg ">
                    ...
                    <div class="flex justify-between items-center mt-4 px-9 py-2">
                        ...
                        <div id="tabs-container" class="relative">
                            <a href="#" class="button border-b-2 border-blue-500  py-2 px-4 transition-all duration-300 translate-x-2">Special Regular Facility</a>
                        </div>
                    ...
                    <div class="relative shadow-md sm:rounded-lg px-9 py-5">
                        <table id="SpecFacTable" class="w-full text-sm text-left rtl:text-right text-black border-2 border-gray-300">
